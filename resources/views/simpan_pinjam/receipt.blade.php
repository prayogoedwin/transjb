...
<body>
    <div class="receipt-container">
        ...
        @php
        $tipeMapping = [
        'bayar' => ['text' => 'Bayar', 'class' => 'bayar'],
        'bayar_cash' => ['text' => 'Bayar Cash', 'class' => 'bayar-cash'],
        'bayar_simpanan' => ['text' => 'Bayar dari Simpanan', 'class' => 'bayar-simpanan'],
        'hutang' => ['text' => 'Hutang', 'class' => 'hutang'],
        'transaksi' => ['text' => 'Transaksi', 'class' => 'transaksi'],
        'ambil' => ['text' => 'Ambil', 'class' => 'ambil'],
        'ambil_simpanan' => ['text' => 'Ambil Simpanan', 'class' => 'ambil-simpanan'],
        'simpan' => ['text' => 'Simpan', 'class' => 'simpan'],
        ];

        $current = $tipeMapping[$simpanPinjam->tipe] ?? ['text' => 'Unknown', 'class' => ''];
        @endphp

        <div class="receipt-content">
            <div style="text-align: center; margin-bottom: 20px;">
                <span class="receipt-type {{ $current['class'] }}">
                    {{ $current['text'] }}
                </span>
            </div>
            ...
            <div class="receipt-row">
                <p>Keterangan: {{ $simpanPinjam->keterangan }}</p>
            </div>
        </div>
