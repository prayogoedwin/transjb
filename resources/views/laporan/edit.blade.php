<x-layouts.app>
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">{{ __('Update product information') }}</p>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="p-6">
            <form action="{{ route('products.update', $product) }}" method="POST" class="max-w-2xl">
                ...
                <div class="mb-6">
                    <x-forms.input label="Harga Beli" name="harga_beli" type="number" step="0.01" min="0" value="{{ old('harga_beli', $product->harga_beli) }}" required />
                </div>
