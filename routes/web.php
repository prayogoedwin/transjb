...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('nasabah/{nasabah}/export-summary-pdf', [NasabahController::class, 'exportSummaryPdf'])->name('nasabah.export-summary-pdf')->middleware('permission:show-nasabah');
